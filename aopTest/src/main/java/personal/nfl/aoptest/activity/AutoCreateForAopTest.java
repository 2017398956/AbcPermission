...
@Aspect
public class AutoCreateForAopTest {

    // private String[] permissions = {"android.permission.WRITE_CONTACTS"};
    private String[] permissions = {"android.permission.WRITE_EXTERNAL_STORAGE"};

    private final String METHOD_CALL = "call(* personal.nfl.aoptest.activity.AopTestActivity.tip(..))";
    private final String METHOD_EXE = "execution(* personal.nfl.aoptest.activity.AopTestActivity.tip(..))";
