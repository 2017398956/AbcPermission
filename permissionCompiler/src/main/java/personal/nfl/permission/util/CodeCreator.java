...
public class CodeCreator {
    ...
    public static String brewCode(String packageName, String enclosingName, String[] permissions, String classPostfix, String methodName, String returnType) {
        return brewCode(packageName, enclosingName, permissions, classPostfix, methodName, returnType, false, false);
    }
    ...
    public static String brewCode(String packageName, String enclosingName, String[] permissions, String classPostfix, String methodName, String returnType, boolean useAndroidX) {
        return brewCode(packageName, enclosingName, permissions, classPostfix, methodName, returnType, useAndroidX, false);
    }

    public static String brewCode(String packageName, String enclosingName, String[] permissions, String classPostfix, String methodName, String returnType, boolean useAndroidX, boolean isKotlinFile) {
        ...
        if (isKotlinFile) {
            ...
            builder.append("import personal.nfl.permission.support.view.Permission23Fragment.PermissionsHandler\n");
            ...
            builder.append("class AutoCreate");
            builder.append(classPostfix);
            builder.append(" { \n\n");

            builder.append("private val permissions = arrayOf(");
            ...
            builder.append("private var proceedingJoinPoint: ProceedingJoinPoint? = null\n");

            builder.append("@Pointcut(\"call(* ");
            builder.append(enclosingName);
            builder.append(".");
            builder.append(methodName);
            builder.append("(..))\"");
            builder.append(")\n");
            builder.append("fun methodCall() {}\n");

            builder.append("@Pointcut(\"execution(* ");
            builder.append(enclosingName);
            builder.append(".");
            builder.append(methodName);
            builder.append("(..))\"");
            builder.append(")\n");
            builder.append("fun methodExe() {}\n");

            // create method beforeCall
            builder.append("fun beforeCall(joinPoint: JoinPoint?) {\n" +
            ...
            builder.append("private val permissionsHandler = PermissionsHandler {\n" +
                    "        try {\n" +
                    "            proceedingJoinPoint!!.proceed()\n" +
                    "        } catch (throwable: Throwable) {\n" +
                    "            AbcPermission.permissionListener.exeException(throwable)\n" +
    ...
    public static String brewCodeNoCallback(String packageName, String enclosingName, String[] permissions, String classPostfix, String methodName, String returnType, boolean useAndroidX, boolean isKotlinFile) {
        StringBuilder builder = new StringBuilder();
        if (isKotlinFile) {
            builder.append("package " + packageName + "\n\n");
            builder.append("import android.app.FragmentManager\n");
            ...
            // create method aroundExe
            builder.append("@Around(\"methodExe()\")\n" +
                    "    fun aroundExe(proceedingJoinPoint: ProceedingJoinPoint): ");
            builder.append(returnType);
            builder.append("? {\n" +
                    "        Log.i(\"NFL\", \"in GetPermissions exe\")\n" +
                    "        if (Build.VERSION.SDK_INT < 14) {\n" +
                    "            return try {\n" +
                    "                proceedingJoinPoint.proceed() as ");
            builder.append(returnType);
            builder.append("\n            } catch (throwable: Throwable) {\n" +
                    "                AbcPermission.permissionListener.exeException(throwable)\n" +
                    "                null\n" +
                    "            }\n" +
                    "        }\n" +
                    "        val permissionList: MutableList<");
            builder.append(returnType);
    ...
    public static String brewCodeNoCallback(String packageName, String enclosingName, String[] permissions, String classPostfix, String methodName, String returnType) {
        return brewCodeNoCallback(packageName, enclosingName, permissions, classPostfix, methodName, returnType, false, false);
    }
    ...
    public static String brewCodeNoCallback(String packageName, String enclosingName, String[] permissions, String classPostfix, String methodName, String returnType, boolean useAndroidX) {
        return brewCodeNoCallback(packageName, enclosingName, permissions, classPostfix, methodName, returnType, useAndroidX, false);
    }
