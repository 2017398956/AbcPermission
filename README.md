...
1. 首先按照 [这里](http://blog.csdn.net/niuzhucedenglu/article/details/78707302 "AbcPermission") 或者下面 ** [1.6之前的方法](https://github.com/2017398956/AbcPermission## 以下是 V1.6 之前的说明) ** 配置好所需的环境；
